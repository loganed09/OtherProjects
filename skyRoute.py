...
def new_route(start_point = None, end_point = None):
  ...
  if shortest_route is not None:
    ...
    print("Unfortunately, there is currently no path betwee {0} and {1} due to maintenance.".format(start_point, end_point))
...
def get_active_stations():
  ...
  for station_under_construction in stations_under_construction:
    for current_station, neigboring_station in vc_metro.items():
